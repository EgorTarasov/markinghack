...
#         history = (
#             history.stack().reset_index().drop("feature", axis=1).melt("timestamp")
#         )
...
#             }
#         )
#         log.info(outp_df.head().__repr__())
...
# # endregion Yarik
REGION_CODES = {i["geoname_code"]: i for i in json.load(open("regions.json", "r"))}
COMPUTED_METHODS = {}
# region Ivan
